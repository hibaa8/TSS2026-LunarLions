function loadDCU() {
  $.getJSON("data/DCU.json", function (data) {
    ...
    if (data.dcu.eva1.batt == true) {
      document.getElementById("eva1BatterySensor").style.backgroundColor =
        "rgba(0, 240, 10, 1)";
    ...
    if (data.dcu.eva1.comm == true) {
      document.getElementById("eva1CommSensor").style.backgroundColor =
        "rgba(0, 240, 10, 1)";
    ...
    if (data.dcu.eva1.fan == true) {
      document.getElementById("eva1FanSensor").style.backgroundColor =
        "rgba(0, 240, 10, 1)";
    ...
    if (data.dcu.eva1.pump == true) {
      document.getElementById("eva1PumpSensor").style.backgroundColor =
        "rgba(0, 240, 10, 1)";
    ...
    if (data.dcu.eva1.co2 == true) {
      document.getElementById("eva1Co2Sensor").style.backgroundColor =
        "rgba(0, 240, 10, 1)";
  ...
  $.getJSON("data/DCU.json", function (data) {
    ...
    if (data.dcu.eva2.batt == true) {
      document.getElementById("eva2BatterySensor").style.backgroundColor =
        "rgba(0, 240, 10, 1)";
    ...
    if (data.dcu.eva2.comm == true) {
      document.getElementById("eva2CommSensor").style.backgroundColor =
        "rgba(0, 240, 10, 1)";
    ...
    if (data.dcu.eva2.fan == true) {
      document.getElementById("eva2FanSensor").style.backgroundColor =
        "rgba(0, 240, 10, 1)";
    ...
    if (data.dcu.eva2.pump == true) {
      document.getElementById("eva2PumpSensor").style.backgroundColor =
        "rgba(0, 240, 10, 1)";
    ...
    if (data.dcu.eva2.co2 == true) {
      document.getElementById("eva2Co2Sensor").style.backgroundColor =
        "rgba(0, 240, 10, 1)";
